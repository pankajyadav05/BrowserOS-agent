...
const GITHUB_REPO_URL: string = "https://github.com/browseros-ai/Mitria";
        ...
        {/* <div className="flex items-center ">
          {providersConfig && (
            <div className="relative mt-0.5">
              <select
                className={`h-9 w-26 pl-2 pr-8 rounded-lg border ${
                  theme === "gray" ? "border-white/40" : "border-border"
                } bg-[hsl(var(--header))] text-foreground text-xs font-light appearance-none`}
